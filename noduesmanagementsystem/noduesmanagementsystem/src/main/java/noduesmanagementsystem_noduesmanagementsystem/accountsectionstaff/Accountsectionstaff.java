...
@Entity
@Table  (name = "accountsectionstaffs")
public class Accountsectionstaff {
	...
	public String toString() {
		return "Accountsectionstaff [registrationid=" + registrationid + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email
				+ " \", password='\" + password + '\\'' + ]";
	}
